import{g as j,a as M}from"./load-trip-BWbivutX.js";import{m as S}from"./nav-B1O7s3M6.js";import{a as A,i as D,e as H,c as N,s as f,b as x,d as U,v as q,n as z,g as F,h as G,j as O,p as L,f as W,k as Y}from"./recap-storage-D_cQpjbH.js";const o=j();let c=null,e=null,I=null;const R=document.getElementById("photo-day"),B=document.getElementById("photo-caption"),T=document.getElementById("photo-place"),p=document.getElementById("photo-input"),h=document.getElementById("photo-grid"),u=document.getElementById("upload-status"),P=document.getElementById("expense-table-wrap"),b=document.getElementById("total-amount"),v=document.getElementById("total-twd"),E=document.getElementById("expense-notes"),y=document.getElementById("btn-save"),J=document.getElementById("btn-import"),K=document.getElementById("btn-export"),Q=document.getElementById("btn-clear"),C=document.getElementById("recap-trip-title");function V(t){document.body.innerHTML=`
